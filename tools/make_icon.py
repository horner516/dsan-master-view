#!/usr/bin/env python3
"""Generate Windows and macOS icons from the D’S mark used by the viewer."""
...
ICNS_OUTPUT = ROOT / "assets" / "dsan-master-view.icns"
SIZE = 1024
image = Image.new("RGBA", (SIZE, SIZE), "#111d27")
draw = ImageDraw.Draw(image)
draw.rounded_rectangle((28, 28, SIZE - 29, SIZE - 29), radius=232, outline="#365267", width=32)
font_paths = [
...
font = ImageFont.truetype(str(font_path), 368) if font_path else ImageFont.load_default()
text = "D’S"
bounds = draw.textbbox((0, 0), text, font=font)
x = (SIZE - (bounds[2] - bounds[0])) / 2 - 12
